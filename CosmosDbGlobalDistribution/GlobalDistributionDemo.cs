...
namespace CosmosDbGlobalDistribution
{
	public static class GlobalDistributionDemo
	{
		public static async Task Run()
		{
            ...
            var endpoint = configuration.GetSection("WusEndpoint").Value;
			var masterKey = configuration.GetSection("WusEndpoint").Value;
			...
			connectionPolicy.PreferredLocations.Add(configuration.GetSection("WusEndpoint").Value);
			connectionPolicy.PreferredLocations.Add(configuration.GetSection("WusEndpoint").Value);
